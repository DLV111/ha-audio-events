...
class TestWebUI(AioHTTPTestCase):
    ...
    async def test_get_source_success(self):
        """Test getting the currently configured source."""
    ...
    @unittest_run_loop
    async def test_get_source_none(self):
        """Test getting source when none is configured."""
    ...
    async def test_set_source_success(self):
        """Test successfully setting the audio source."""
